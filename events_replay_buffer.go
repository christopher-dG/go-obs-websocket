...
// ReplayStartingEvent : A request to start the replay buffer has been issued. Since: 4.2.0.
...
// ReplayStartedEvent : Replay Buffer started successfully. Since: 4.2.0.
...
// ReplayStoppingEvent : A request to stop the replay buffer has been issued. Since: 4.2.0.
...
// ReplayStoppedEvent : Replay Buffer stopped successfully. Since: 4.2.0.
