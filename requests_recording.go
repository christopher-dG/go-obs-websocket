...
// StartStopRecordingRequest : Toggle recording on or off. Since: 0.3.
...
// StartStopRecordingResponse : Response for StartStopRecordingRequest. Since: 0.3.
// https://github.com/Palakis/obs-websocket/blob/master/docs/generated/protocol.md#startstoprecording
...
// StartRecordingRequest : Start recording. Will return an `error` if recording is already active. Since: 4.1.0.
...
// StartRecordingResponse : Response for StartRecordingRequest. Since: 4.1.0.
// https://github.com/Palakis/obs-websocket/blob/master/docs/generated/protocol.md#startrecording
...
// StopRecordingRequest : Stop recording. Will return an `error` if recording is not active. Since: 4.1.0.
...
// StopRecordingResponse : Response for StopRecordingRequest. Since: 4.1.0.
// https://github.com/Palakis/obs-websocket/blob/master/docs/generated/protocol.md#stoprecording
...
// SetRecordingFolderRequest : Change the current recording folder. Since: 4.1.0.
...
type SetRecordingFolderRequest struct {
	RecFolder string `json:"rec-folder"` // Path of the recording folder.
	_request
}
...
// SetRecordingFolderResponse : Response for SetRecordingFolderRequest. Since: 4.1.0.
// https://github.com/Palakis/obs-websocket/blob/master/docs/generated/protocol.md#setrecordingfolder
...
// GetRecordingFolderRequest : Get the path of  the current recording folder. Since: 4.1.0.
...
// GetRecordingFolderResponse : Response for GetRecordingFolderRequest. Since: 4.1.0.
// https://github.com/Palakis/obs-websocket/blob/master/docs/generated/protocol.md#getrecordingfolder
