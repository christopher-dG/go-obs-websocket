...
// SetCurrentProfileRequest : Set the currently active profile. Since: 4.0.0.
...
type SetCurrentProfileRequest struct {
	ProfileName string `json:"profile-name"` // Name of the desired profile.
	_request
}
...
// SetCurrentProfileResponse : Response for SetCurrentProfileRequest. Since: 4.0.0.
// https://github.com/Palakis/obs-websocket/blob/master/docs/generated/protocol.md#setcurrentprofile
...
// GetCurrentProfileRequest : Get the name of the current profile. Since: 4.0.0.
...
// GetCurrentProfileResponse : Response for GetCurrentProfileRequest. Since: 4.0.0.
// https://github.com/Palakis/obs-websocket/blob/master/docs/generated/protocol.md#getcurrentprofile
type GetCurrentProfileResponse struct {
	ProfileName string `json:"profile-name"` // Name of the currently active profile.
	_response
}
...
// ListProfilesRequest : Get a list of available profiles. Since: 4.0.0.
...
// ListProfilesResponse : Response for ListProfilesRequest. Since: 4.0.0.
// https://github.com/Palakis/obs-websocket/blob/master/docs/generated/protocol.md#listprofiles
type ListProfilesResponse struct {
	Profiles interface{} `json:"profiles"` // List of available profiles. TODO: Unknown type (Object|Array).
	_response
}
