...
// ProfileChangedEvent : Triggered when switching to another profile or when renaming the current profile. Since: 4.0.0.
...
// ProfileListChangedEvent : Triggered when a profile is created, added, renamed, or removed. Since: 4.0.0.
