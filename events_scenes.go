...
// SwitchScenesEvent : Indicates a scene change. Since: 0.3.
// https://github.com/Palakis/obs-websocket/blob/master/docs/generated/protocol.md#switchscenes
type SwitchScenesEvent struct {
	SceneName string   `json:"scene-name"` // The new scene.
	Sources   []string `json:"sources"`    // List of sources in the new scene.
	_event
}
...
// ScenesChangedEvent : The scene list has been modified. Scenes have been added, removed, or renamed. Since: 0.3.
...
// SceneCollectionChangedEvent : Triggered when switching to another scene collection or when renaming the current scene collection. Since: 4.0.0.
...
// SceneCollectionListChangedEvent : Triggered when a scene collection is created, added, renamed, or removed. Since: 4.0.0.
